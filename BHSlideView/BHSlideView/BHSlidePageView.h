...
@interface GJGCSlidePageView : UIView

@property (nonatomic,weak)id<GJGCSlidePageDelegate> delegate;
@property (nonatomic,assign)NSInteger selectedIndex;
@property (nonatomic,strong)GJGCTitleBar *titleBar;
...
@protocol GJGCSlidePageDelegate <NSObject>
@required
/**
 *  获取page的View
 *
